...
The current slice follows a telemetry event through a new Investigation, Job and Task execution, to closure. See [SLICE-INSTRUCTIONS.md](SLICE-INSTRUCTIONS.md). This mode is still being developed.
